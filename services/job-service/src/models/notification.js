...
// job-service creates job_application / job_application_status notifications
// here; notification-service (M2) reads them. The realtime socket emit moves to
// the realtime-gateway in M5 — see docs/migration §7.
